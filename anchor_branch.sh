...
mkdir -p Output8/anchordis${ancdis}/Conwayreportanchordis${ancdis}
cp ./a.out SelectDNAII.cpp stat.h stat.cpp $1 Output8/anchordis${ancdis}
cd Output8/anchordis${ancdis}
...
./a.out $1 100 $ancdis 20 > Conwayreportanchordis${ancdis}/Conway_report.txt
rm run*
cp best.pcld Conwayreportanchordis${ancdis}/
bdac=$(grep '1' best.pcld | wc -l)
done
